...
# curl -fsSL https://raw.githubusercontent.com/evanriley/dotfiles/master/bin/install | bash
# or
# wget -qO- https://raw.githubusercontent.com/evanriley/dotfiles/master/bin/install | bash
