...
do
  local options = {expandtab = true, tabstop = 2, shiftwidth = 2, softtabstop = 2, completeopt = "menu,menuone,noselect", ignorecase = true, smartcase = true, clipboard = "unnamedplus", number = true, relativenumber = true, ruler = true, signcolumn = "number", cmdheight = 1, conceallevel = 0, pumheight = 10, splitbelow = true, splitright = true, foldcolumn = "auto:1", foldlevel = 99, foldlevelstart = 99, wrap = false, backup = false}
